...
<template>
  <div class="flex items-center justify-between border-t border-dashed py-4 dark:border-dark-600">
    <!-- Small screen -->
...
.button {
  @apply inline-flex items-center rounded-md border border-gray-200 bg-white px-2.5 py-1 text-sm font-medium text-gray-400 hover:bg-gray-50 focus:z-20 dark:border-dark-600 dark:bg-dark-800 dark:text-dark-400 hover:dark:bg-dark-600 dark:hover:text-dark-300;
}
.arrow-button {
  @apply inline-flex items-center border border-gray-200 bg-white px-1 py-1 text-sm font-medium text-gray-400 hover:bg-gray-50 focus:z-20 disabled:cursor-not-allowed disabled:text-gray-200 dark:border-dark-600 dark:bg-dark-800 dark:text-dark-400 hover:dark:bg-primary-500/20 hover:dark:bg-dark-600 dark:hover:text-dark-300 dark:disabled:cursor-not-allowed dark:disabled:text-dark-600 dark:disabled:hover:bg-dark-800;
}
.active {
